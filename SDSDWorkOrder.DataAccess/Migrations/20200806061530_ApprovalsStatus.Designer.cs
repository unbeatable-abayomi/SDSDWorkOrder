...
namespace SDSDWorkOrder.DataAccess.Migrations
{
    ...
    [Migration("20200806061530_ApprovalsStatus")]
    partial class ApprovalsStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SDSDWorkOrder.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = "C451.002",
                            Location = "Africa",
                            Name = "Seaways International DMCC"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = "C452.003",
                            Location = "Europe",
                            Name = "AKRON TRADE and TRANSPORT"
                        },
                        new
                        {
                            Id = 3,
            ...
            modelBuilder.Entity("SDSDWorkOrder.Models.Comment", b =>
                {
                    ...
                    b.Property<bool>("MGApproval")
                        .HasColumnType("bit");

                    b.Property<bool>("PMApproval")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SDSDWorkOrder.Models.WorkOrders", b =>
                {
                    ...
                    b.Property<string>("AnnualFDHBalance")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TimeChargeable")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SDSDWorkOrder.Models.WorkOrders", b =>
                {
                    ...
                    b.HasOne("SDSDWorkOrder.Models.Product", "Product")
                        .WithMany()
